...
const LcDetails:React.FC = () => { const meetings = [
  {
    id: 1,
    host: "Nayan Pillai",
  ...
  <div className={styles.learningCircle}>
    ...
    <header className={styles.header}>
      <div className={styles.headerL}>
        <p>
          The UI/UX Learning Circle at the College of Engineering Trivandrum
          is an interactive, collaborative space designed to explore the
          essential principles and practices of user interface (UI) and user
          experience (UX) design. Targeted at students across various
          disciplines of engineering, this learning circle aims to deepen
          understanding of how design impacts functionality, usability, and
          user satisfaction in digital products. Through workshops, hands-on
          sessions, and peer-to-peer discussions, participants will delve into
          the core concepts of UI/UX design, including wireframing,
          prototyping, usability testing, and the latest trends in digital
          design. Students will also engage in real-world case studies and
          practical exercises, gaining insights from industry experts and
      ...
      <div className={styles.headerR}>
        ...
        <div className={styles.locationInfo}>
          <div className={styles.locationItem}>
            ...
            <span>Sreekaryam, Trivandrum</span>
          </div>
          <div className={styles.locationItem}>
        ...
        <div key={meeting.id} className={styles.meetingCard}>
          ...
          <div className={styles.cardButtons}>
            <button className={styles.actionButton}>
              <span>Copy Link  <FaLink className={styles.icon} /> </span>
            </button>
